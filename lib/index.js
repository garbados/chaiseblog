            ...
            <div>
              <div class="message-header">
                ...
                <span>
                  ...
                  <button class="button is-small is-danger is-outlined" onClick={ this.onDelete }>Delete</button>
                </span>
              </div>
...
class Entries extends Component {
  constructor (props) {
    ...
    // TODO pagination
    db.query([name, 'entries'].join('/'), opts)
      .then((result) => {
        console.log(result)
...
class Welcome extends Component {
  render ({ hasEntries, name }, state) {
    // TODO determine hasEntries prior to starting app!!!
    return (
      <div>
        { hasEntries ? (
          <Entries />
          ...
          <div class="columns">
            ...
            <div class="column">
              <Router history={ createHashHistory() }>
                <Welcome name={ name } path="" />
                <Entry editing title="Make a new entry" path="new-entry" />
                <Entry title="View an entry" path="show/:_id" />
